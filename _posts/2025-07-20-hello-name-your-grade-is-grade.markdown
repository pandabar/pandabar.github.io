...
[My script](https://pandabar.github.io/python_misc) needs a .csv file with your students' names and grades. I had three small assignments (whose average is worth 20% of their final grade), a midterm (30%), and a final exam (50%). You will also need to create an empty folder for the output.
