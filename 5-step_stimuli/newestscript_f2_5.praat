...
#Creates synthesized 5-step vowel continua with Klatt grids.
#F1 UNTOUCHED!
#Vowels created after Hillenbrand et al (1995).

#Target directory
out_directory$ = "F2_5/individual_f2_5"
...
#formant values
Add oral formant frequency point... 1 0.08 f1startval
#+(-(dif_f1/4)*(i-1))
Add oral formant bandwidth point... 1 0.08 50
Add oral formant frequency point... 2 0.08 f2startval+(-(dif_f2/4)*(i-1))
Add oral formant bandwidth point... 2 0.08 100
Add oral formant frequency point... 1 0.21 f1startval
#+(-(dif_f1/4)*(i-1))
Add oral formant bandwidth point... 1 0.21 50
Add oral formant frequency point... 2 0.21 f2startval+(-(dif_f2/4)*(i-1))
...
#Saving sound files
Write to WAV file... 'out_directory$'/f2'cont$'_'i'.wav
endfor
endfor